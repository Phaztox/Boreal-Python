clear;
for numberFichier=24:26
    

    
file= 'test3j_150219_180219'
extension='.bin'
fIn_name = strcat( file, '_', num2str(numberFichier), extension)
f = fopen(fIn_name, 'r');
...
Result.IMU_label = {'Time','Xaccl', 'Yaccl', 'Zaccl','Xgyro', 'Ygyro', 'Zgyro', 'Xmagn', 'Ymagn', 'Zmagn', 'TemperatureIMU','Barometer','TemperaturePressure','Secondes','TSmilli'};
%    Result.IMU = zeros(floor(length_data/512*10), 12);     %  Il y a 10 valeures par lignes 
 Result.IMU = zeros(floor(length_data/taille_fichier), 15);
 %i_IMU = 1;
...
% end
%==================================================================%
Result.MOTUSRAW_label = {'Time','Xaccl', 'Yaccl', 'Zaccl','Xgyro', 'Ygyro', 'Zgyro', 'Xmagn', 'Ymagn', 'Zmagn', 'TemperatureIMU','Barometer','TemperaturePressure','Secondes','TSmilli'};
%    Result.IMU = zeros(floor(length_data/512*10), 12);     %  Il y a 10 valeures par lignes 
 Result.MOTUSRAW = zeros(floor(length_data/taille_fichier)*10, 15);
...
data=Result;
extension='.mat';
fOut_name = strcat( 'data', file, '_', num2str(numberFichier),extension);
save(fOut_name,'data');
clear data
end
