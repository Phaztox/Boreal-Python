...
legend('HCE1_{corr}','HCE2_{corr}','LDE_{corr}')
ylabel('Pressure top and bottom')
%xlabel('Time in s')
...
plot(p_horiz_LDE_NR); hold on
plot(p_horiz_LDE_NR_ws); hold on
legend('LDE','LDE_{corr}')
ylabel('Pressure left and right')
...
plot(p_Stat2_NR)
hold on;
plot(p_Stat2_NR_ws,'r')
ylabel('Baro pressure mbar')
xlabel('')
legend('Original','After spikes removal')
...
plot(p_Pitot_NR_ws); hold on ; plot(p_centrale_NR_ws)
...
plot(filloutliers(data.TH(Seuil_bas:Seuil_haut,6),'nearest')); hold on
plot(filloutliers(data.TH(Seuil_bas:Seuil_haut,8),'nearest'))
legend('Temp1','Temp2','Temp1_{corr}','Temp2_{corr}')
...
plot(filloutliers(data.TH(Seuil_bas:Seuil_haut,7),'nearest')); hold on
plot(filloutliers(data.TH(Seuil_bas:Seuil_haut,9),'nearest'))
legend('Hum1','Hum2','Hum1_{corr}','Hum2_{corr}')
...
T_p100=filloutliers(data.T2(Seuil_bas:Seuil_haut,3),'nearest');
rho = 100*p_Stat2_NR_ws(1:10:end)./(R*(T_p100+273));  % 100 pour convsersion mb=>pascal et degre kelvin
AirSpeed_5hole= sqrt(abs((200.*p_centrale_NR_ws(1:10:end))./rho)); %Bernoulli eq'n using mbar
AirSpeed_Pitot = sqrt(abs((200.*p_Pitot_NR_ws(1:10:end))./rho));
...
subplot(3,1,1)
plot(Phi,'b')
hold on; plot(Phi_ws,'r')
ylim([-50,50])
ylabel('Roll angle (degrees)')
legend('Original','After spikes removal')
subplot(3,1,2)
plot(Theta,'b')
hold on; plot(Theta_ws,'r')
ylim([-50,50])
ylabel('Pitch angle (degrees)')
subplot(3,1,3)
plot(Psi)
hold on; plot(Psi_ws,'r')
ylim([0,400])
...
figure('Name','East Ground speed')
plot(Vg_East); hold on
plot(Vg_East_ws)
legend('Original','After spikes removal')
ylabel('East Ground speed in m/s')

figure('Name','North Ground speed')
plot(Vg_North); hold on
plot(Vg_North_ws)
legend('Original','After spikes removal')
ylabel('North Ground speed in m/s')

figure('Name','Vertical Ground speed')
plot(Vg_Down); hold on
plot(Vg_Down_ws)
legend('Original','After spikes removal')
ylabel('Vetical Ground speed in m/s')
...
figure('Name','Wind speed and direction')
subplot(2,1,1)
...
plot(filloutliers(data.AD_NAVIGATION(Seuil_bas:Seuil_haut,6),'nearest').*180/pi, filloutliers(data.AD_NAVIGATION(Seuil_bas:Seuil_haut,7),'nearest').*180/pi,'b')
set(gca, 'FontSize', 12)
